...
function json_to_list(str, container) {
	...
	var op = inputList[i];
	create_op(op.sub, document.getElementById("eventBuilder"), op.type);
    }
...
function eventConfig() {
    ...
    console.log(schema);
    eventMap = schema.events;
    commands = schema.commands;
    deviceTypes = schema.devicetypes;
    devices = deviceMap;
